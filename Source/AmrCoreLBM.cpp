                                    ...
                                    const DistributionMapping& dm)
{
    ...
    amrex::Print() << "Making new level " << lev << " from coarse, ncomp = " << ncomp << std::endl;
...
void
AmrCoreLBM::FillPatch (int lev, Real time, MultiFab& mf, int icomp, int ncomp)
{
    // if (lev == 0)
    // {
    //     Vector<MultiFab*> smf;
...
void
AmrCoreLBM::FillCoarsePatch (int lev, Real time, MultiFab& mf, int icomp, int ncomp)
{
    // BL_ASSERT(lev > 0);
...
void
AmrCoreLBM::GetData (int lev, Real time, Vector<MultiFab*>& data, Vector<Real>& datatime)
{
    // data.clear();
    // datatime.clear();
...
void
AmrCoreLBM::timeStepNoSubcycling (Real time, int iteration)
{
...
Real
AmrCoreLBM::EstTimeStep (int lev, Real time)
{
    // BL_PROFILE("AmrCoreLBM::EstTimeStep()");
